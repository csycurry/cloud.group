            ...
            <div class="footer-inner clearfix">
                <div id="tbfaq" class="footer_help clearfix">
                    <dl class="fo_a">
                        <dt>新手指南</dt>
                        <dd>
                            <a target="_blank" href="" class="faqtips"></a>
                        </dd>
                        <dd>
                            <a target="_blank" href="" class="faqtips"></a>
                        </dd>
        ...
        <div class="footer-bot-outer">
            <div class="footer-inner">
                ...
                <div class="police-icon">
		 		    <a target="_blank" class="police-icon-a" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=XXXXXX">
                        <img src="http://www.beian.gov.cn/img/ghs.png" style="float:left;"/><span class="police-icon-span">公网安备 XXXXXX号</span> 
                    </a>
		 	    </div>
            </div>
        </div>
