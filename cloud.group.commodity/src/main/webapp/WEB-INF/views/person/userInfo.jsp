...
<body>
	...
	<div class="head clearfix">
		<div class="userCtn pull-left">
			<p>
				您好，<span class='username'>${user.userCode}</span> <input
					type="button" class="btn" onclick="changePwd()" value="修改密码" />
			</p>
			<p>
				<span>ID：</span>${user.id}</p>
			<p>
				<span>手机号码：</span>${user.userMobile}
				<c:if test="${user.userMobile==null||user.userMobile=='' }">
					<input type="button" onclick="bind()" class="btn" value="绑定手机号" />
				</c:if>
			</p>
			<p>
				<span>QQ 号码：</span>${user.userQq}</p>
			<p>
				<span>邮<span class='mg'></span>箱：
				</span>${user.userMail}</p>
			<p>
				<span>注册日期：</span>${user.createDate}</p>
		</div>
		<div class="balance pull-right">
			...
			<div class="balanceCtn">
				...
				<a href="/userPay.html" class='sqtx'> <img
					src="assets/main//img/sqtx.png" /></a>
			</div>
		</div>
	</div>
	<div class="userCommon">
		<h4>
			<img src="assets/main/img/userIcon11.png" />收益记录
		</h4>
		<ul id="myTab" class="nav nav-tabs">
			<li class="active"><a href="#one" data-toggle="tab"> 待返还 </a></li>
			<li><a href="#two" data-toggle="tab"> 已返还 </a></li>
			<li><a href="#three" data-toggle="tab"> 无返还 </a></li>
		</ul>
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane fade in active" id="one">
				<div class="panel panel-default" style="padding: 20px">
					<table data-toggle="table" data-url="/rebateslist.html?type=1"
						data-pagination="true" data-side-pagination="server"
						data-page-list="[5, 10, 20, 50, 100, 200]" data-height="300">
						<thead>
							<tr>
								<th data-formatter="runningFormatter">序号</th>
								<th data-field="earnings" data-align="center"
									data-sortable="true">结算金额</th>
								<th data-field="missionName" data-align="center"
									data-sortable="true">商品</th>
								<th data-field="typeCn" data-align="center" data-sortable="true">结算说明</th>
								<th data-field="statusCn" data-align="center"
									data-sortable="true">结算状态</th>
								<th data-field="createDate" data-align="center"
									data-sortable="true">结算时间</th>
							</tr>
						</thead>
					</table>
				</div>
			...
			<div class="tab-pane fade" id="two">
				<div class="panel panel-default" style="padding: 20px">
					<table data-toggle="table" data-url="/rebateslist.html?type=2"
						data-pagination="true" data-side-pagination="server"
						data-page-list="[5, 10, 20, 50, 100, 200]" data-height="300">
						<thead>
							<tr>
			...
			<div class="tab-pane fade" id="three">
				<div class="panel panel-default" style="padding: 20px">
					<table data-toggle="table" data-url="/rebateslist.html?type=3"
						data-pagination="true" data-side-pagination="server"
						data-page-list="[5, 10, 20, 50, 100, 200]" data-height="300">
						<thead>
							<tr>
