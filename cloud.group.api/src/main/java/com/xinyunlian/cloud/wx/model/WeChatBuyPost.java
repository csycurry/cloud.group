/**
 * 微信公众平台开发发模式(JAVA) SDK
 * (c) 2012-2013 夏悸 <wmails@126.cn>, MIT Licensed
 ...
 */
public class WeChatBuyPost implements  Serializable {

	private String OpenId;			// 支付该笔订单的用�? ID
	private String AppId;			// 公众号id
	private int IsSubscribe;		// 用户是否关注了公众号1 为关注，0 为未关注
