                    ...
                    <div class='span12 box'>
                        ...
                        <div class='box-content'>
                         <form id="groupBuyForm" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
				                ...
				                <div class='control-group'>
                                    <label class='control-label' >是否允许切换Ip</label>
                                    <div class='controls'>
				                        <label class='radio inline'>
				                            <input type='radio' name="ipChange" checked="checked"  value='1' />
				                            	是
				                        </label>
				                        <label class='radio inline'>
				                            <input type='radio' name="ipChange"   value='0' />
				                            	否
				                        </label>
				                    </div>
                                </div>
				                <div class='control-group'>
				                    ...
				                    <div id="imageresult">
				                    <div id="imageDiv" style="display: ${m.imageUrl==null?'none':'block'}">
