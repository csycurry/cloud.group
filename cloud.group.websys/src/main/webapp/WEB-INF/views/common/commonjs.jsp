 <!--[if lt IE 9]>
    ...
    <link href="${pageContext.request.contextPath}/assets/uploadify/uploadify.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/layerjs/layer.js"></script>
...
<script src="${pageContext.request.contextPath}/assets/uploadify/jquery.uploadify.js" type="text/javascript" charset="utf-8"></script>