...
<div id="myCarousel" class="carousel slide">
	...
	<c:forEach items="${banners}" var="banner" varStatus="status">
		...
		<c:if test="${status.index>0}">
			...
			<a  href="${banner.link}" width="100%"><img src="${banner.url}" alt="First slide" width="100%"></a>
		</div>
	</c:forEach>
	</div>
	<!-- 轮播（Carousel）导航 -->
	...
	<!-- <div id="slidey" style="display:none;">
		...
		<c:forEach items="${banners}" var="banner">
			<li><a href="http://www.baidu.com"><img src="${banner.url}" alt=" "><p class='description'>${banner.title}</p></a></li>
		</c:forEach>
		</ul>   	
    </div>
    <script src="assets/index/js/jquery.slidey.js"></script>
    <script src="assets/index/js/jquery.dotdotdot.min.js"></script>
	   <script type="text/javascript">
			$("#slidey").slidey({
				interval: 8000,
				listCount: 5,
