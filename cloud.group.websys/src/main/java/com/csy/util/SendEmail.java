...
public class SendEmail
{
    ...
    {    
         ...
         mail.setPortNumber("587");   			//设置邮件服务器端口号,默认25
         mail.setSender("444712707@qq.com");   			//发送人
         mail.setName("昵称");   					//发送人昵称
         mail.setReceiver("444712707@qq.com"); 			//接收人  
         mail.setUsername("444712707@qq.com"); 			//登录账号,一般都是和邮箱名一样
         mail.setPassword("idzllduafgwicbda");  //QQ邮箱登录第三方客户端时,密码框请输入“授权码”进行验证。其他的密码具体查看邮件服务器的说明
         mail.setSubject("标题");  
