            ...
            <form accept-charset="UTF-8" id='userInfo'><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                <div class='row-fluid'>
                    <div class='span12 icon-over-input'>
                        <input class="span12" id="code" name="code" placeholder="用户名" type="text" value="" />
...
<script type="text/javascript">
 function  userSubmit()
 {
	 ...
	 $.ajax({
		 url:'/backstage/staff/login.json',
		 data:$('#userInfo').serialize(),// 你的formid
			type:'post',  
			dataType:'json',  
			success:function(data) {  
			if(data.status==1){  
				alert("登录成功");  
				location.href="/main.json";
